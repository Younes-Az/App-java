package fr.ynov.demo.web.rest;

import fr.ynov.demo.DevApp;
import fr.ynov.demo.config.Constants;
import fr.ynov.demo.domain.User;
import fr.ynov.demo.repository.AuthorityRepository;
import fr.ynov.demo.repository.UserRepository;
import fr.ynov.demo.security.AuthoritiesConstants;
import fr.ynov.demo.service.UserService;
import fr.ynov.demo.service.dto.PasswordChangeDTO;
import fr.ynov.demo.service.dto.UserDTO;
import fr.ynov.demo.web.rest.vm.KeyAndPasswordVM;
import fr.ynov.demo.web.rest.vm.ManagedUserVM;
...
import static fr.ynov.demo.web.rest.AccountResourceIT.TEST_USER_LOGIN;
